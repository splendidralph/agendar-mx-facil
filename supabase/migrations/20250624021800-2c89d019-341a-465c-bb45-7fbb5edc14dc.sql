...
-- Step 1: ONLY create the enum type first
DO $$ 
BEGIN
...
-- Step 2: Create or update users table structure
...
-- Step 3: Ensure role column is correctly typed
DO $$
BEGIN
...
-- Step 4: Drop the existing trigger function if it exists (to recreate it cleanly)
DROP FUNCTION IF EXISTS public.handle_new_user CASCADE;

-- Step 5: Now create the function (enum should definitely exist by now)

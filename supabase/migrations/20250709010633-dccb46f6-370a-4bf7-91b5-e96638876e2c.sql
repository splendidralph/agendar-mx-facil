...
-- Fix the validate_provider_profile function to include theme_color in is_image_only_update check
-- This prevents full validation from running when only theme color is being updated

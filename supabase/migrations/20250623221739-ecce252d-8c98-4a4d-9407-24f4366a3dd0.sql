...
-- Step 2: Confirm enum was created
SELECT 'user_role enum type created' AS message;

-- Step 3: Make sure users table exists with role column using user_role
...
-- Step 4: Alter role column to user_role if it exists but is wrong type
ALTER TABLE public.users
  ALTER COLUMN role TYPE user_role USING role::user_role;

-- Step 5: Now create the function (only after enum exists)
...
-- Step 7: Enable and configure RLS policies

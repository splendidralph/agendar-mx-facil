...
DROP TABLE IF EXISTS public.bookings, public.availability, public.services, public.providers, public.locations, public.users CASCADE;
DROP TYPE IF EXISTS user_role, booking_status, service_category CASCADE;
DROP FUNCTION IF EXISTS public.handle_new_user CASCADE;
DROP FUNCTION IF EXISTS public.update_updated_at_column CASCADE;

-- Create enum types first (to avoid casting errors)

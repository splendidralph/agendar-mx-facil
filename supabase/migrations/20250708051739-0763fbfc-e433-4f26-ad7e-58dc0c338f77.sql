-- Update the create_default_notification_preferences function to automatically enable WhatsApp when provider has a phone
...
-- Fix existing providers who have phones but disabled WhatsApp notifications
UPDATE public.notification_preferences 
SET 

        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-10 max-w-5xl mx-auto">
            <p className="text-2xl md:text-3xl text-white mb-4 font-medium leading-relaxed">
              {t('hero.description1')} <span className="font-bold bg-gradient-to-r from-white to-white bg-clip-text text-transparent text-3xl md:text-4xl">{t('hero.description2')}</span> {t('hero.description3')}
            </p>
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-xl px-6 py-4 text-lg border border-white/30 inline-block">
              <span className="text-sm block text-white mb-1">{t('hero.linkPreview')}</span>
          ...
          <div className="flex justify-center">
            <Button 
              size="lg" 
              className="accent-gradient text-white hover:opacity-90 shadow-xl px-10 py-6 text-xl font-bold group border-0 hover-lift"
